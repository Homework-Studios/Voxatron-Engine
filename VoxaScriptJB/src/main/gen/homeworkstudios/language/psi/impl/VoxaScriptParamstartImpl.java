...
public class VoxaScriptParamstartImpl extends ASTWrapperPsiElement implements VoxaScriptParamstart {

  public VoxaScriptParamstartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull VoxaScriptVisitor visitor) {
    visitor.visitParamstart(this);
  }
